            ...
            <div className={classes["body-product-dt"]}>
                <div className={classes["product-img-dt"]}>
                    ...
                    <div className="product-img-big-dt">
                        {product.product_images &&
                        product.product_images.length > 0 ? (
                            <img src={product.product_images.split(",")[0]} />
                        ) : (
                ...
                <div className={classes["product-text-dt"]}>
                    <div className={classes["product-title-dt"]}>
                        <span>
                            Multi-Active Night Face Cream - All Skin Types
                        </span>
                        <div className={classes["star-dt"]}>
                            <div className={classes["iconstar-dt"]}>
                                <FontAwesomeIcon
                                    className={classes["starl-dt"]}
                                    icon={faStar}
                                />
                                <FontAwesomeIcon
                                    className={classes["starl-dt"]}
                            ...
                            <Link to="#">
                                <div className={classes["review-dt"]}>
                                    2752 REVIEWS
                                </div>
                            </Link>
                        </div>
                    ...
                    <div className={classes["product-des-dt"]}>
                        A multi-tasking daily moisturizer for all skin types
                        powered <br></br>
                        by 2% Niacinamide and Organic Sea Holly bio-extract*
                        <br></br>
                        targets the first signs of aging to visibly smooth
                        lines, refine <br></br>pores, skin texture, and help
                        strengthen skin's moisture barrier for a radiant,
                        youthful glow.
                    </div>
                    <div className={classes["price-dt"]}>
                        {formatter.format(product.price)}
                    </div>
                    <div className={classes["price-des-dt"]}>
                        Or 4 interest-free payments of $14.75 with{" "}
                        <img src={require("../../assets/afterpay.png")}></img>
                    </div>
                    ...
                    <div className={classes["boxcontainer-dt"]}>
                            ...
                            <label className={classes["radio-container-dt"]}>
                                <div className={classes["checker-dt"]}>
                                    <input
                                        ...
                                        value="one-time"
                                    />
                                    <span className={classes["radio-label-dt"]}>
                                        One-time purchase
                                    </span>
                                </div>
                                {/* <span className={classes["price-dt"]}>$59.00</span> */}
                                <span className={classes["price-dt"]}>
                                    {formatter.format(product.price)}
                                </span>
                            </label>
                        </div>
                        ...
                        <div className={classes["option-dt"]}>
                            <label className={classes["radio-container-dt"]}>
                                ...
                                <span
                                    className={
                                        classes["price subscription-price-dt"]
                                    }
                                >
                                    {formatter.format(product.price * 0.9)}
                                </span>
                            </label>

                            <ul className={classes["subscription-details-dt"]}>
                                <li>
                                    10% off + free shipping + 3 free samples
                                </li>
                            ...
                            <select
                                className={classes["shipping-frequency-dt"]}
                            >
                                <option>
                                    Ships every 3 months (recommended)
                                </option>
                                <option>
                                    Ships every 2 months (recommended)
                                </option>
                                <option>
                                    Ships every 1 months (recommended)
                                </option>
                                <option>
                                    Ships every 5 months (recommended)
                                </option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div className={classes["last-dt"]}>
                        ...
                        <div className={classes["third-last-dt"]}>
                            ...
                            <span>
                                Earn 590 points or more with this purchase!
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <section className={classes["how"]}>
                ...
                <div className={classes["box-container"]}>
                    <div className={classes["glider-contain"]}>
                        <FontAwesomeIcon
                            className="chevron-fa-two"
                            icon={faChevronLeft}
                        />
                        <FontAwesomeIcon
                            className="chevron-fa-one"
                            icon={faChevronRight}
                        />
                    </div>
